...
public class VendorController {
	...
	//insert data , and send email
	@RequestMapping(value="/insertVen",method=RequestMethod.POST)
	public String insertData(@ModelAttribute("vendor")Vendor ven,ModelMap map,
			@RequestParam("fileinputs")CommonsMultipartFile file
			){
		int id=service.saveVendor(ven);
		String resMsg="Saved succesfully ,with id:"+id;
		//on saving vendor to DB ,also send email
		commonUtil.sendEmail(ven.getVenMail(), "Welcome to VDM..", resMsg,file);
