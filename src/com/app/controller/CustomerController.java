...
public class CustomerController {
	...
	//do insert into db
	/***
	 * 1.read data from UI onlcick
	 * submit button from Reg page
	 * as modelAttribute
	 * 2.generate pwd and tock
	 * and decode and set into 
	 * model object
	 * 3.original values send to
	 * email.
	 */
	...
	public String saveCustomer(@ModelAttribute("customer")Customer cust,ModelMap map){
		...
		String text="welcome to customer("+cust.getCustType()+")"
				...
				+"Password:"+pwd+",tocken:"+tock
				+"...all the best";
		//sending email
		commonUtil.sendEmail(cust.getCustEmail(), "welcome to VDM Family..", text);
